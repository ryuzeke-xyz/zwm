...
static const char *fonts[]          = { "hack:size=12", "hack:size=12" };
...
//	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("pamixer --allow-boost -d 3; kill -44 $(pidof dwmblocks)") },
	...
	//brightness controls
	{ 0, XF86XK_MonBrightnessUp,	spawn,		SHCMD("xbacklight -inc 25") },
	{ 0, XF86XK_MonBrightnessDown,	spawn,		SHCMD("xbacklight -dec 25") },
};
